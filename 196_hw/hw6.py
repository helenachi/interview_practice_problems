...
# Alive People
#
# Write a function that, given a list of strings representing a person's birth 
# year: age of death, will return the year that had the most people alive 
# (inclusive). If there are multiple years that tie, return the earliest.
# You can think of a birthdate and a deathdate as a range of years. Of all the 
# birth years in the list, find the one where the highest amount of people in 
# the list were still alive.
#
# Examples
# ----------
# Example 1:
...
# Number to Text
#
# Write a function that given a number from 0-100, will return the string which 
# is a English representation of the number.
...
# Rotate Matrix
#
# Write a function that given an NxN matrix will rotate the matrix to the left 
# 90 degrees
#
# Examples
# ----------
...
#
# Write a function that given an array of integers will return the continuous 
# subarrray with the largest sum in the entire array
#
#
# Example(s)
# ----------
...
#
# Your favorite course staff member really likes strings that have the same 
# occurances of letters. This means the staff member likes "aabbcc" and "ccddee"
# and even strings like "abcabcabc"
#
# But "that one guy that wrote the pokomon problem" wants to trick the staff 
# with really long string, that either could be the string that the staff member
# likes, or something that becomes such a string when you remove a single 
# character from the string.
#
# Your goal is to return True if it's a string that the "one guy that wrote the 
# pokomon problem" made and False otherwise.
#
# Restrictions
# ------------
# Inputs are only given as lower case alphabets, without punctuation, spaces, 
# etc.
...
# Example 1:
#   Input: "abcbabcdcdda"
#   There is 3 a's, 3 b's, 3 c's, and 3 d's. That means it is a very likable 
#   string!
#   Output:
#   True
#
...
#   We can remove this string however, and it will become a likeable string, so 
#   this is valid.
#   Output:
#   True
#
...
#   This string is similar to the other ones, except with 2 e's, f's and g's at 
#   the end.
#   To make this string likable, we need to remove the 2 e's, f's, and g's or we
#   can remove one a, b, c, and d. However all of these require more than one 
#   removal, so it becomes invalid.
#   Output:
#   False
#
# Parameters
...
# -------
# bool
#   True if the string is likable, or removing a single character makes it 
#   likable.
#   
#   False if the string is not likeable, and we need to remove more than 1 
#   character to become likable.
def string_my_one_true_love(string):
    pass

# Gene Manipulation
#
# It's year 2050, and we have gotten advanced technology to manipulate genes at 
# will.
# We consider a good gene to be when the "ATCG"s are balanced. That is for a 
# gene length n,
# there are n/4 A's, T's, C's, and G's. Our technology allows us to "flash" the 
# genes, replacing a subsequence of a gene with anything we want.
#
# Given a arbiturary gene, find the length of the minimum substring of the 
# string representation of the gene we need to flash to get a good gene.
# 
#
# Restrictions
# ------------
# Inputs are only given as a string containing uppercase A, T, C, and Gs.
# The input size is always a multiple of 4 (or else we will never get a good 
# gene)
...
# Example 1:
#   Input: "ATCGGATT"
#   We can remove the last T and change it to a C in order to make it a good 
#   gene.
#   Output:
#   1
#
# Example 2:
#   Input: "ATCGAAAAATCG"
#   We can remove the "AAA" and change it to a "CTG" in order to make it a good 
#   gene.
#   Output:
#   3
#
...
# Three Sum
#
# Given an array S of n integers and constant 'target', are there elements a, b,
# c in S such that a+b+c = target? Find all unique triplets in the array which 
# gives the sum of target. Return a 2d list, where all inner lists are triplets.
# There may be more than one pair of triplets.
#
