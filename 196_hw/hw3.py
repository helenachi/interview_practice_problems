...
# Lazy Trainer
#
# Recently, there has been extensive research done on Pokomon's (don't sue us) 
# training method.
# Turns out, we have made a rapid advancements in how Pokomon gain experience! 
# We can now gain
...
#              increase our Experience by Current Strength * The Enemy's 
#              hitpoints.
# 2. Belly Drum -- This will increase our Pokomon's Strength by 1, and the 
#                  battle end. (I guess Pokomon are afraid of belly drums).
#
# But as a 8th Time Entrier in the Hall of Fame, we have become very very lazy.
#
# Given a sequence of Pokomons to fight (with corresponding Hit Points), return 
# the maximum experience we can gain with our new battle method! 
# (Correction: ) You can fight the Pokomon in any order.
# i.e. You can fight Pokomon #4 without fighting Pokomon #1.
#
# The Pokomon starts with Strength = 1 and Experience = 0. We are interested in 
# training lots of Pokomon after all!
#
# Restriction(s)
# --------------
